...
<html lang="en">
  <head>
    ...
    <link href="lib/docs/examples/signin/signin.css" rel="stylesheet">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" role="form" action="order" method="POST">
        <h2 class="form-signin-heading">Please sign in</h2>
        <input type="text" class="form-control" placeholder="Username" name="user_name" required>
        <input type="password" class="form-control" placeholder="Password" name="pass_word" required>
